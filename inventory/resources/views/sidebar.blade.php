...
<aside id="separator-sidebar" class=" text-white bg-green-700 fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 text-white bg-green-700">
   <div class="h-full px-3 py-4 overflow-y-autotext-white bg-green-700">
      <ul class="space-y-2">
         ...
         <li>
            <a href="/inventory/users" class="hover:underline flex items-center p-2 text-base font-normal white-900 rounded-lg dark:text-white  ">
          ...
          <li>
            <a href="/inventory/consignments" class="hover:underline flex items-center p-2 text-base font-normal white-900 dark:text-white transition duration-75 rounded-lg   group">
         ...
         <li>
            <a href="/inventory/compartments" class="hover:underline flex items-center p-2 text-base font-normal white-900 dark:text-white transition duration-75 rounded-lg   group">
               <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
          ...
          <li>
            <a href="/inventory/category" class="hover:underline flex items-center p-2 text-base font-normal white-900 dark:text-white transition duration-75 rounded-lg   group">
         ...
         <li>
            <a href="/inventory/items" class="hover:underline flex items-center p-2 text-base font-normal white-900 rounded-lg dark:text-white  ">
         ...
         <li>
            <a href="/inventory/borrows" class="hover:underline flex items-center p-2 text-base font-normal white-900 rounded-lg dark:text-white  ">
         ...
         <li>
            <a href="/inventory/orders" class="hover:underline flex items-center p-2 text-base font-normal white-900 rounded-lg dark:text-white  ">
         ...
         <li>
            <a href="/inventory/dashboard" class="hover:underline flex items-center p-2 text-base font-normal white-900 dark:text-white rounded-lg  ">
          ...
          <li>
            <a href="/inventory/vendors" class="hover:underline flex items-center p-2 text-base font-normal white-900 transition duration-75 rounded-lg   dark:text-white group">
               <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
         ...
         <li>
            <a href="/inventory/logmeout" class="hover:underline flex items-center p-2 text-base font-normal white-900 rounded-lg dark:text-white  ">
