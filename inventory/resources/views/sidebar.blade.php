...
<aside id="separator-sidebar" class=" text-white bg-green-700 fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 text-white bg-green-700">
   <div class="h-full px-3 py-4 overflow-y-autotext-white bg-green-700">
      <ul class="space-y-2">
         ...
         <li>
            <a href="{{ route('processed_cart') }}" class="hover:underline flex items-center p-2 text-base font-normal white-900 rounded-lg dark:text-white  ">
         ...
         <li>
            <a href="/inventory/" class="hover:underline flex items-center p-2 text-base font-normal white-900 rounded-lg dark:text-white  ">
